    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-8 pb-6 text-center">
          {/* Logo in the "shine" */}
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-accent/25 via-accent/10 to-amber-400/5 border border-accent/30 shadow-[0_0_0_1px_rgba(249,115,22,0.15)]">
            <LogoIcon className="w-9 h-9 text-accent" />
          </div>
          ...
          <p className="text-[15px] text-muted leading-relaxed mb-6">
            Sign in with Google to write, run, and build real Rust muscle memory.
          </p>
          ...
          <div className="space-y-3">
            ...
            >
              {/* Proper full-color Google G icon (no clipping) */}
